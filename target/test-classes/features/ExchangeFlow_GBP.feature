...
Feature: End to End Exchange flow - GBP
  ...
  Background:
    Given I setup test data file name for "ForeignExchange" "GBP" "10"

  @corp
  Scenario Outline: Verify the end to end flow of Exchange flow for GBP corridor
...
#    Then I search for the transaction with "<reference>", "<type>" and "<status>"
    ...
    Examples:
      ...
      | GBP         | 10.00     | Instant        | +91 7989730020 | Foreign Exchange |                      |